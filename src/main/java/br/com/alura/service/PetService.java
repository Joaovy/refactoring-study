...
public class PetService {
    ...
    public void listPetsShelter() throws IOException, InterruptedException {
        ...
        for (Pet pet : petsList) {
            ...
            long id = pet.getId();
            String tipo = pet.getType();
            String nome = pet.getName();
            String raca = pet.getBreed();
            int idade = pet.getAge();
    ...
    public void importPetsShelter() throws IOException, InterruptedException {
        System.out.println("Digite o id ou nome do abrigo:");
        String idOuNome = new Scanner(System.in).nextLine();
